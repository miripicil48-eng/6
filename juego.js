class Juego extends Phaser.Scene {
    ...
    // Colocamos el fondo del juego
    let fondo = this.add.image(width / 2, height / 2, "fondoJuego");
    ...
    for (let y = 0; y < filas; y++){
        ...
        this.cubierta.add(img);
                ...
                img.on("pointerdown", () => {
                    ...
                    // SISTEMA DE PUNTOS
                    if (img.texture.key === "light"){
                        this.puntos += 1;
                    }

                    if (img.texture.key === "misa"){
                        this.puntos += 2;
                    }

                    if (img.texture.key === "matsuda"){
                        this.puntos += 3;
                    }
